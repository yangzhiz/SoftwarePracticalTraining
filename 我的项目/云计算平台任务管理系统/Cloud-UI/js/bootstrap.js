(function() {
	...
	isDevelopment=false;
    document.write('<script type="text/javascript" src="' + path + 'jquery-1.4.2.min.js"></script>');
	document.write('<script type="text/javascript" src="' + path + 'common' + ((isDevelopment) ? '.min' : '') + '.js"></script>');
	document.write('<script type="text/javascript" src="' + path + 'ygui' + ((isDevelopment) ? '.min' : '') + '.js"></script>');
